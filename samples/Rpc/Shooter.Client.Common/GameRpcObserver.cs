...
public class GameRpcObserver : IGameRpcObserver
{
    ...
    private readonly ForkleansRpcGameClientService _clientService;
    
    public GameRpcObserver(ILogger<GameRpcObserver> logger, ForkleansRpcGameClientService clientService)
    {
        _logger = logger;
