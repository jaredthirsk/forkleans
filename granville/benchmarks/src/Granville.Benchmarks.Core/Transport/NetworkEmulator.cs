...
{
    /// <summary>
    /// Represents network condition parameters for testing.
    /// </summary>
    public class NetworkCondition
    {
        ...
        public double PacketLoss { get; set; } = 0.0; // 0.0 to 1.0
        public long Bandwidth { get; set; } = 0; // bits per second, 0 = unlimited
    }
    /// <summary>
