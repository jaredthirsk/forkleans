...
Write-Host "Creating Orleans.Core NuGet package..." -ForegroundColor Cyan

$version = "9.1.2.61-granville-shim"
$packageId = "Microsoft.Orleans.Core"

# Create package directory structure
$packageDir = "package-orleans-core"
...
# Copy the shim DLL
$shimPath = "shims-proper/Orleans.Core.dll"
if (-not (Test-Path $shimPath)) {
    Write-Host "✗ Shim not found at $shimPath" -ForegroundColor Red
    exit 1
}

Copy-Item -Path $shimPath -Destination "$libDir/Orleans.Core.dll" -Force
...
<package xmlns="http://schemas.microsoft.com/packaging/2010/07/nuspec.xsd">
  <metadata>
    ...
    <title>Orleans.Core</title>
    <authors>Granville</authors>
    <owners>Granville</owners>
    <description>Orleans Core shim for Granville Orleans compatibility - includes GrainInterfaceUtils and all type forwards</description>
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Type="http://schemas.microsoft.com/packaging/2010/07/manifest" Target="/Microsoft.Orleans.Core.nuspec" Id="Rc7a5f2b7e6944e0f" />
</Relationships>
'@
...
Write-Host "✓ Successfully created Orleans.Core package v$version" -ForegroundColor Green
