...
Write-Host "Creating Orleans.Serialization.Abstractions NuGet package..." -ForegroundColor Cyan

$version = "9.1.2.$VersionSuffix-granville-shim"
$packageId = "Microsoft.Orleans.Serialization.Abstractions"

# Create package directory structure
$packageDir = "package-orleans-serialization-abstractions"
if (Test-Path $packageDir) {
    Remove-Item -Path $packageDir -Recurse -Force
}

$libDir = "$packageDir/lib/netstandard2.0"
New-Item -ItemType Directory -Path $libDir -Force | Out-Null

# Copy the shim DLL
$shimPath = "shims-proper/Orleans.Serialization.Abstractions.dll"
if (-not (Test-Path $shimPath)) {
    Write-Host "✗ Shim not found at $shimPath" -ForegroundColor Red
    exit 1
}

Copy-Item -Path $shimPath -Destination "$libDir/Orleans.Serialization.Abstractions.dll" -Force
...
<package xmlns="http://schemas.microsoft.com/packaging/2010/07/nuspec.xsd">
  <metadata>
    ...
    <title>Orleans.Serialization.Abstractions</title>
    <authors>Granville</authors>
    <owners>Granville</owners>
    <description>Orleans Serialization Abstractions shim for Granville Orleans compatibility</description>
...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  <Relationship Type="http://schemas.microsoft.com/packaging/2010/07/manifest" Target="/Microsoft.Orleans.Serialization.Abstractions.nuspec" Id="Rc7a5f2b7e6944e0f" />
</Relationships>
'@
...
Write-Host "✓ Successfully created Orleans.Serialization.Abstractions package v$version" -ForegroundColor Green
