...
public class StatsCollectorGrain : Orleans.Grain, IStatsCollectorGrain
{
    private readonly Orleans.Runtime.IPersistentState<StatsCollectorState> _state;
    private readonly ILogger<StatsCollectorGrain> _logger;

    public StatsCollectorGrain(
        [Orleans.Runtime.PersistentState("statsCollector", "statsStore")] Orleans.Runtime.IPersistentState<StatsCollectorState> state,
