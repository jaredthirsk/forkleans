...
namespace Orleans.Storage
{
    ...
    internal class MartenGrainKey
    {
        ...
        public MartenGrainKey(long key, string keyExtension)
        {
            N0Key = 0;
            N1Key = key;
        ...
        public MartenGrainKey(Guid key, string keyExtension)
        {
        ...
        public MartenGrainKey(string key)
        {
            StringKey = key;
            N0Key = 0;
            N1Key = 0;
