...
{
    public const string MartenInvariantName = "Npgsql";

    /// <summary>
    /// Logging codes used by <see cref="MartenGrainStorage"/>.
    /// </summary>
    ...
    public static class MartenGrainStorageFactory
    {
        public static IGrainStorage Create(IServiceProvider services, string name)
        {
            ...
            return ActivatorUtilities.CreateInstance<MartenGrainStorage>(services, Options.Create(optionsMonitor.Get(name)), name, clusterOptions);
        }
    }
    ...
    public class MartenGrainStorage: IGrainStorage, ILifecycleParticipant<ISiloLifecycle>
    {
        ...
        public MartenGrainStorage(
            ILogger<MartenGrainStorage> logger,
            IProviderRuntime providerRuntime,
            IOptions<MartenGrainStorageOptions> options,
        ...
        {
            lifecycle.Subscribe(OptionFormattingUtilities.Name<MartenGrainStorage>(this.name), this.options.InitStage, Init, Close);
        }
        ...
        {
            Storage = RelationalStorage.CreateInstance(InvariantName, options.ConnectionString);
        ...
        private static MartenGrainKey GrainIdAndExtensionAsString(GrainId grainId)
        {
            string keyExt;
