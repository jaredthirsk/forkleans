    ...
    internal partial class AzureBasedMembershipTable : IMembershipTable
    {
        ...
        private static MembershipEntry Parse(SiloInstanceTableEntry tableEntry)
        {
            ...
            if (suspectingSilos.Count != suspectingTimes.Count)
                throw new ForkleansException(string.Format("SuspectingSilos.Length of {0} as read from Azure table is not equal to SuspectingTimes.Length of {1}", suspectingSilos.Count, suspectingTimes.Count));
