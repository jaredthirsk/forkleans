        ...
        public SimpleRpcGrainContext(GrainAddress address, GrainType grainType, IServiceProvider serviceProvider, ILogger logger)
        {
            ...
            try
            {
                ...
                if (GrainInstance is Forkleans.Grain grain)
                {
                    ...
                    var grainContextProperty = typeof(Forkleans.Grain).GetProperty("GrainContext", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
